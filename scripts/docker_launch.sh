...
do
    ...
    gnome-terminal --tab --title=$SC_NUM" - Oisl Sim"     -- $DFLAGS -v $SIM_DIR:$SIM_DIR --name $SC_NUM"_oisl_sim"     --network=$SC_NETNAME -w $SIM_BIN $DBOX ./nos3-single-simulator $SC_CFG_FILE oisl_sim
    echo ""
done
