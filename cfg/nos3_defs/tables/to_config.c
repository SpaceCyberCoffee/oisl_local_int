...
{
   {
       ...
       {CFE_SB_MSGID_WRAP_VALUE(OISL_HK_TLM_MID),            {0,0},  32,  0xffff,     TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
       {CFE_SB_MSGID_WRAP_VALUE(OISL_DEVICE_TLM_MID),        {0,0},  32,  0xffff,     TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
